...
ActorInfo D_80372970 = { 0x1C1, 0x2AE, 0x0, 0, N64_NULL, func_8035933C, N64_NULL, func_80325340,  0, 0, 0.0f, 0};
ActorInfo D_80372994 = { 0x1C1, 0x2AF, 0x0, 0, N64_NULL, func_8035933C, N64_NULL, func_80325340,  0, 0, 0.0f, 0};
ActorInfo D_803729B8 = { 0x1C1, 0x2B0, 0x0, 0, N64_NULL, func_8035933C, N64_NULL, func_80325340,  0, 0, 0.0f, 0};
ActorInfo D_803729DC = { 0x1C1, 0x2B1, 0x0, 0, N64_NULL, func_8035933C, N64_NULL, func_80325340,  0, 0, 0.0f, 0};
ActorInfo D_80372A00 = { 0x1C1, 0x2B2, 0x0, 0, N64_NULL, func_8035933C, N64_NULL, func_80325340,  0, 0, 0.0f, 0};
ActorInfo D_80372A24 = { 0x1C1, 0x2B3, 0x0, 0, N64_NULL, func_8035933C, N64_NULL, func_80325340,  0, 0, 0.0f, 0};
ActorInfo D_80372A48 = { 0x1C1, 0x316, 0x0, 0, N64_NULL, func_80359424, N64_NULL, func_80325340,  0, 0, 0.0f, 0};
ActorInfo D_80372A6C = { 0x1C1, 0x317, 0x0, 0, N64_NULL, func_80359454, N64_NULL, func_80325340,  0, 0, 0.0f, 0};
