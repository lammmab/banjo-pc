...
static SnackerCtlState _snackerctl_update_bottles_bonus(void){
    ...
    if(func_8034BB48() && chBottlesBonus_getPuzzleIndex() != 7){
        gcdialog_showDialog(SNACKER_BB_DIALOG_0 + (chBottlesBonus_getPuzzleIndex() << 1), 6, D_80363610, N64_NULL, N64_NULL, N64_NULL);
    }
        ...
        if(__snackerctl_player_within_distance(183.0f, -100.0f, 75.0f)){
            if(chBottlesBonus_getPuzzleIndex() == 6){
                if(!D_8037DCCC){
                    ...
                    gcdialog_showDialog(SNACKER_BB_DIALOG_1, 0x6, D_80363610, N64_NULL, func_8028A584, N64_NULL);
                }
            }//L8028A70C
            else if(chBottlesBonus_getPuzzleIndex() == 7){
                func_8028F94C(4, &D_80363610);
                gcdialog_showDialog(ASSET_E35_DIALOG_BOTTLES_BONUS_REMINDER, 0x6, D_80363610, N64_NULL, func_8028A558, N64_NULL);
                D_8037DCCC = 1;
            }//L8028A764
                ...
                if( (((D_8036361C[0] <= sp30[0])? (sp30[0] - D_8036361C[0]) : -(sp30[0] - D_8036361C[0])) < 4.0f)
                    ...
                    if(!D_8037DCCA){
                        func_8028F94C(4, &D_80363610);
                        gcdialog_showDialog(ASSET_E21_DIALOG_BOTTLES_BONUS_DISCOVERED, 6, D_80363610, 0, func_8028A584, N64_NULL);
                        D_8037DCCA = 1;
                    }else{
                        func_8028A584(0,0,0);
                    }
                ...
                if(!D_8037DCCB){
                    func_8028F94C(4, &D_80363610);
                    gcdialog_showDialog(ASSET_E20_DIALOG_BOTTLES_BONUS_NOT_READY, 6, D_80363610, 0, func_8028A558, N64_NULL);
                    D_8037DCCB = 1;
                }
            }
        }
