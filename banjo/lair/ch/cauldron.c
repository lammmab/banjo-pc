...
void func_8038AC7C(Actor *this) {
    ...
    if(
        ...
        if (35.0 < this->lifetime_value) {
            ...
            if (gcdialog_showDialog(sp2C + this->unk38_31, 0, N64_NULL, N64_NULL, N64_NULL, N64_NULL)) {
                this->unk38_31++;
        ...
        if (fileProgressFlag_get(chWarpCauldron_getFileProgressFlagIndex(this))) {
            ...
            if (!fileProgressFlag_get(FILEPROG_F5_COMPLETED_A_WARP_CAULDRON_SET) && fileProgressFlag_get(chWarpCauldron_getPairedFileProgressFlagIndex(this))) {
                if (func_802D677C(-1) != map_get()) {
                    gcdialog_showDialog(ASSET_F7A_DIALOG_UNKNOWN, 4, N64_NULL, N64_NULL, N64_NULL, N64_NULL);
    ...
    switch(this->state){
        case 1: //L8038B0F4
            if (func_8038A690(this)) {
                ...
                if (!fileProgressFlag_get(FILEPROG_F5_COMPLETED_A_WARP_CAULDRON_SET) && !fileProgressFlag_get(chWarpCauldron_getPairedFileProgressFlagIndex(this))) {
                    gcdialog_showDialog(ASSET_F79_DIALOG_UNKNOWN, 4, N64_NULL, N64_NULL, N64_NULL, N64_NULL);
                }
        ...
        case 6: //L8038B64C
            if (func_8038A690(this) && !fileProgressFlag_get(FILEPROG_F3_MET_DINGPOT)) {
                gcdialog_showDialog(ASSET_FAD_DIALOG_DINGPOT_MEET, 0xA, this->position, N64_NULL, __chWarpCauldron_dingpotDialogCallback, N64_NULL);
            }
            this->unk38_0 = true;
