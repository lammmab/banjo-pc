...
void func_80387828(ActorMarker *caller, enum asset_e text_id, s32 arg2){
    ...
    if (text_id == 0xc00) {
        gcdialog_showDialog(ASSET_C2B_DIALOG_UNKNOWN, 0xf, N64_NULL, this->marker, N64_NULL, func_803877A8);
    }
}
...
void func_8038794C(Actor *this){
    ...
    if(!this->volatile_initialized){
        ...
        marker_setCollisionScripts(this->marker, N64_NULL, func_80387754, N64_NULL);
        this->unk38_31 = 1;
    ...
    switch(this->state){
        case 1://L80387AB0
            ...
            if(mapSpecificFlags_get(0x1)){
                ...
                func_80324DBC(1.0f, 0xc00, 0xe, N64_NULL, this->marker, func_80387828, func_803877A8);
                func_803876A4(this);
                break;
            }//L80387B38
            ...
            if(!this->has_met_before && subaddie_playerIsWithinSphereAndActive(this, 0x1f4)){
                if(!player_movementGroup() || player_movementGroup() == BSGROUP_8_TROT){
                    if (gcdialog_showDialog(ASSET_BFF_DIALOG_UNKNOWN, 0x2a, this->position, N64_NULL, N64_NULL, N64_NULL)) {
                        for (i = 0; i < 5; i++) {
