        ...
        if (subaddie_playerIsWithinSphereAndActive(this, 350)) {
            if (player_getTransformation() == TRANSFORM_4_WALRUS) {
                if (!levelSpecificFlags_get(LEVEL_FLAG_31_FP_UNKNOWN)) {
                    if (gcdialog_showDialog(ASSET_C27_DIALOG_UNKNOWN, 0x23, N64_NULL, N64_NULL, N64_NULL, N64_NULL)) {
                ...
                if (!levelSpecificFlags_get(LEVEL_FLAG_32_FP_UNKNOWN)) {
                    if (gcdialog_showDialog(ASSET_C26_DIALOG_UNKNOWN, 0x23, N64_NULL, N64_NULL, N64_NULL, N64_NULL)) {
