...
/* .data */
ActorInfo D_8038F380 = { 0x1C6, 0x310, 0x501, 0x0, N64_NULL, func_8038C41C, N64_NULL, actor_draw, 0, 0, 0.0f, 0};
ActorInfo D_8038F3A4 = { 0x1C7, 0x311, 0x462, 0x0, N64_NULL, func_8038C41C, N64_NULL, func_8038C380, 0, 0, 0.0f, 0};
ActorInfo D_8038F3C8 = { 0x1C8, 0x312, 0x463, 0x0, N64_NULL, func_8038C41C, N64_NULL, actor_draw, 0, 0, 0.0f, 0};
ActorInfo D_8038F3EC = { 0x1C9, 0x313, 0x464, 0x0, N64_NULL, func_8038C41C, N64_NULL, actor_draw, 0, 0, 0.0f, 0};
ActorInfo D_8038F410 = { 0x1CA, 0x314, 0x502, 0x0, N64_NULL, func_8038C41C, N64_NULL, actor_draw, 0, 0, 2.0f, 0};
ActorInfo D_8038F434 = { 0x1CB, 0x315, 0x48D, 0x0, N64_NULL, func_8038C41C, N64_NULL, func_8038C380, 0, 0, 0.0f, 0};
...
void func_8038C41C(Actor *this) {
    ...
    if ((this->marker->id == 0x1CB) && (this->state == 2)) {
        ...
        if (!this->has_met_before && (ml_vec3f_distance(this->position, sp2C) < 400.0f)) {
            ...
            gcdialog_showDialog(0xCCD, 0, N64_NULL, N64_NULL, N64_NULL, N64_NULL);
        }
    }
}
