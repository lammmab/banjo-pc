...
ActorInfo D_80390640 = {
    MARKER_191_ENGINE_ROOM_PROPELLOR_1, ACTOR_1BB_ENGINE_ROOM_PROPELLOR_1, ASSET_40F_MODEL_ENGINE_ROOM_PROPELLER_1, 0x0, N64_NULL,
    func_8038944C, N64_NULL, actor_draw,
    0, 0, 0.0f, 0
};

ActorInfo D_80390664 = {
    MARKER_192_ENGINE_ROOM_PROPELLOR_2, ACTOR_1BC_ENGINE_ROOM_PROPELLOR_2, ASSET_410_MODEL_ENGINE_ROOM_PROPELLER_2, 0x0, N64_NULL,
    func_8038944C, N64_NULL, actor_draw,
    0, 0, 0.0f, 0
};

ActorInfo D_80390688 = {
    MARKER_193_ENGINE_ROOM_PROPELLOR_3, ACTOR_1BD_ENGINE_ROOM_PROPELLOR_3, ASSET_411_MODEL_ENGINE_ROOM_PROPELLER_3, 0x0, N64_NULL,
    func_8038944C, N64_NULL, actor_draw,
    0, 0, 0.0f, 0
};
